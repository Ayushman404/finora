...
const ACCOUNT_ID = "060feca8-4494-4136-b874-a784b20714ef";
const USER_ID = "b23547a6-e278-4928-b58c-4ac020c8ce4e";
...
export async function seedTransactions() {
  try {
    ...
    await db.$transaction([
      ...
      // Insert new transactions (⚡ without id field)
